...
<html lang="en">
  ...
  <nav class="title navbar navbar-expand-sm navbar-light bg-white">
    <div class="container-fluid">
      <div class="row mr-auto ml-auto">
        <div class="col-12">
          <a href="#" class="navbar-brand h1 mb-0 greenness">Greenness</a>
      ...
      <div class="container-fluid">
        <div class="row ml-auto mr-auto">
          <div class="col-12">
            ...
            <button class="btn btn-success navbar-toggler" type="button" data-toggle="dropdown" data-target="#navbarMenu">
