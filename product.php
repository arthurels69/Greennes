				...
				<div class="row">
							...
							<div class="card" style="height: 100%;">
								<div class="row no-gutters">
									<div class="col-12 col-sm-4">
										<img src="./images/Canette bleue.jpg" data-toggle="modal" data-target="#infosbleue" class="img-fluid" alt="canette bleue">
									</div>
					...
					<div class="card_product col-12 col-lg-6">
							<div class="card" style="height: 100%;">
								<div class="row no-gutters" style="height: 100%;">
									<div class="col-12 col-sm-4">
										<img src="./images/Canette rouge.jpg" data-toggle="modal" data-target="#infosrouge" class="img-fluid" alt="canette rouge">
									</div>
					...
					<div class="card_product col-12 col-lg-6">
							<div class="card" style="height: 100%;">
								<div class="row no-gutters">
									<div class="col-12 col-sm-4">
										<img src="./images/Canette verte.jpg" data-toggle="modal" data-target="#infosverte" class="img-fluid" alt="canette verte">
									</div>
					...
					<div class="card_product col-12 col-lg-6">
							<div class="card" style="height: 100%;">
								<div class="row no-gutters" style="height: 100%;">
									<div class="col-12 col-sm-4">
										<img src="./images/Canette jaune.jpg" data-toggle="modal" data-target="#infosjaune" class="img-fluid" alt="canette jaune">
									</div>
